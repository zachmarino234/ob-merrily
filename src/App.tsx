...
function App() {
  ...
  return (
    ...
    <button
      ...
      className={`fixed bottom-6 right-6 z-50 inline-flex h-12 w-12 items-center justify-center rounded-full bg-black text-white shadow-lg transition-all duration-300 ease-out hover:scale-105 cursor-pointer ${
        isScrolled ? 'translate-y-0 opacity-100' : 'pointer-events-none translate-y-24 opacity-0'
      }`}
    >
      <ArrowUp />
    </button>
